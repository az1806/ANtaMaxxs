...
<html>
  ...
  <script type="text/javascript">
  	...
  	if(leibie!=""){
  	window.location.href="admin/ZixunLeiServlet?method=zxadd&leibie="+leibie;
          ...
          <tr>
          	<% for(int i=0;i<list.size();i++){ %>
        		<tr>
		            ...
		            <td class="td-manage">
		              <a title="编辑"  onclick="x_admin_show('编辑','admin/ZixunLeiServlet?method=getzx&id=<%=list.get(i).getId() %>')">
		                <i class="layui-icon">&#xe642;</i>
		              </a>
		              <a title="删除" onclick="member_del(this,'要删除的id')" href="admin/ZixunLeiServlet?method=zxupdate&id=<%=list.get(i).getId() %>">
		                <i class="layui-icon">&#xe640;</i>
		              </a>
		            </td>
		          </tr>
